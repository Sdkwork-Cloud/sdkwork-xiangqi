...
```bash
npm install @sdkwork-internal/xiangqi-app-sdk-generated
# or
yarn add @sdkwork-internal/xiangqi-app-sdk-generated
# or
pnpm add @sdkwork-internal/xiangqi-app-sdk-generated
```

## Quick Start

```typescript
import { SdkworkXiangqiAppClient } from '@sdkwork-internal/xiangqi-app-sdk-generated';

const client = new SdkworkXiangqiAppClient({
  baseUrl: '/app/v3/api',
  timeout: 30000,
});
...
```typescript
// GET /app/v3/api/xiangqi/matches
const params = {
  page: 1,
  page_size: 2,
  status: 'status',
